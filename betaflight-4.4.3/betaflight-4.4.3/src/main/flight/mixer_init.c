...
PG_RESET_TEMPLATE(mixerConfig_t, mixerConfig,
    ...
    .mixerMode1 = DEFAULT_MIXER,
    .mixerMode2 = DEFAULT_MIXER,
...
PG_REGISTER_ARRAY(motorMixer_t, MAX_SUPPORTED_MOTORS, customMotorMixer_1, PG_MOTOR_MIXER_1, 0);

PG_REGISTER_ARRAY(motorMixer_t, MAX_SUPPORTED_MOTORS, customMotorMixer_2, PG_MOTOR_MIXER_2, 0);

mixerMode_e currentMixerMode;
uint8_t currentMixerIndex;
...
static void mixerConfigureOutput(void)
{
    ...
    if (currentMixerMode == MIXER_CUSTOM || currentMixerMode == MIXER_CUSTOM_TRI || currentMixerMode == MIXER_CUSTOM_AIRPLANE) {
        ...
        for (int i = 0; i < MAX_SUPPORTED_MOTORS; i++) {
            ...
            //    break;
            //}
            mixerRuntime.currentMixer[i] = *getCustomMotorMixerByIndices(systemConfig()->pidProfileIndex,i);
...
void mixerInit(mixerMode_e mixerMode, uint8_t mixerIndex)
{
